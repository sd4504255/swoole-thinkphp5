...
class App
{
    ...
    {
        $array = ['type' => $type];
        if(isset($dispatch[$type])){
            $array[$type] =  $dispatch[$type];
        }
        if(isset($dispatch['var']) && is_array($dispatch['var'])){
            $array['var'] = $dispatch['var'];
        }
        if(!isset($dispatch[$type]) && !isset($dispatch['var'])){
            $array[$type] =  $dispatch;
        }
        self::$dispatch = $array;
    }
